...
public class TurretControllerCopy : MonoBehaviour
{
    ...
    private void FindNearestEnemy()
    {
        ...
        while (i < hitColliders.Length)
        {
            ...
            if (Physics.Raycast(catPosition, catDirection, out hit, turretRadius))
            {
                ...
                Vector3 catVelocity = hitColliders[i].transform.GetComponent<CatCopyWithDeath>().Velocity;
    ...
    private void Fire(Vector3 position, Vector3 forward)
    {
        ...
        bullet.GetComponent<BulletControllerCopy>().SetTarget(this, position, bulletSpawnOffset);
